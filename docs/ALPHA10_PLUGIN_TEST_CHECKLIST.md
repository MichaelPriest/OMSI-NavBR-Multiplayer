...
> Este checklist cobre a **v0.3.0-alpha.10-test.6** em desenvolvimento. A prerelease geral recomendada continua sendo a **v0.3.0-alpha.9**.

Use a prerelease permanente de integração quando publicada:
