...
public static class NavBRFeatureCatalog
{
    ...
    [
        ...
        new("peer-host", "Peer-host multiplayer", NavBRFeatureState.Experimental, true, false, "TCP 27730 peer-host, diagnostics, network quality metrics and optional UPnP are included."),
        ...
        new("dispatcher", "CCO / Dispatcher", NavBRFeatureState.InDevelopment, true, false, "Local and read-only multiplayer monitoring are included; dispatch commands, assignments and incidents remain in development."),
        new("session-sync", "Session time/date/weather sync", NavBRFeatureState.InDevelopment, true, false, "Included in Alpha.12 as an in-development module; host authority and follow-host policies come in later waves."),
        ...
        new("portal", "Alpha.12 web portal", NavBRFeatureState.InDevelopment, true, false, "Alpha.12 Test 1 portal and high-resolution vector hero are published; feature/status matrix continues evolving."),
