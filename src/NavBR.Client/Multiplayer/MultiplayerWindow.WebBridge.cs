        ...
        var players = _players.Values
            ...
            .Select(player =>
            {
                ...
                return new
                {
                    ...
                    physicalVehicleErrorMessage = physicalVehicleStatus?.ErrorMessage,
                    ...
                    physicalTelemetryGridX = !isLocal ? telemetry?.GridX : null,
                    physicalTelemetryGridY = !isLocal ? telemetry?.GridY : null,
